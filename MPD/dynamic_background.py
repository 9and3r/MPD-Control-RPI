...
class DynamicBackground (object):
    ...
    def __new__(cls, *args, **kargs): 
	    ...
	    cls.instance.colorR = random.randint(0, 150)
	    cls.instance.colorG = random.randint(0, 150)
	    cls.instance.colorB = random.randint(0, 150)
	    cls.instance.R = random.randint(0, 150)
	    cls.instance.G = random.randint(0, 150)
	    cls.instance.B = random.randint(0, 150)
	    cls.instance.colorTime = 0
